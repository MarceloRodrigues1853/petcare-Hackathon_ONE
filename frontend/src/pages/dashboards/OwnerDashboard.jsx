...
function calculateTotal(appointments) {
  return appointments.reduce(
    (total, apt) => total + (apt.sitterServicoPreco?.valor || 0),
    0
  );
}
  ...
  const fetchAppointments = useCallback(async () => {
    ...
    try {
      ...
      if (err?.status === 401) {
        ...
        setError("Sem permissão para listar agendamentos com o perfil atual.");
      } else {
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Bem-vindo(a) ao seu painel. Aqui está um resumo dos seus pets e
            agendamentos.
          </p>
        </header>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {apt.sitterServicoPreco?.servico?.descricao ||
                          "Serviço"}
                      </p>
                    </div>
                  </div>
