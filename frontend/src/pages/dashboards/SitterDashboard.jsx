// src/pages/dashboards/sitter/SitterDashboard.jsx
...
export default function SitterDashboard() {
    ...
    (async () => {
      try {
        ...
        const [s, a] = await Promise.all([
          getSitterStats(),           // { totalAppointments, monthlyRevenue, rating }
          getUpcomingAppointments(5), // [{id, clientName, petName, serviceName, startAt}]
        ]);
        setStats(s);
        setAppointments(a);
      } catch (e) {
  ...
  if (loading) return <div className="p-8 text-center text-gray-500">Carregando seu painel...</div>;
    ...
    <div className="bg-slate-50 min-h-screen p-4 sm:p-8">
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Resumo da sua atividade.</p>
        </header>
        ...
        <main className="space-y-8">
          <section className="bg-white p-6 rounded-xl shadow-md">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <Link to="/sitter/services" className="flex flex-col items-center justify-center p-4 bg-gray-100 rounded-lg hover:bg-blue-100 transition-colors">
                <Cog className="text-blue-600 mb-2" size={28} /><span className="font-semibold text-gray-700">Meus Serviços</span>
              </Link>
              <Link to="/sitter/profile/edit" className="flex flex-col items-center justify-center p-4 bg-gray-100 rounded-lg hover:bg-blue-100 transition-colors">
                <User className="text-blue-600 mb-2" size={28} /><span className="font-semibold text-gray-700">Editar Perfil</span>
              </Link>
              <Link to="/sitter/appointments" className="flex flex-col items-center justify-center p-4 bg-gray-100 rounded-lg hover:bg-blue-100 transition-colors">
                <Calendar className="text-blue-600 mb-2" size={28} /><span className="font-semibold text-gray-700">Agendamentos</span>
              </Link>
              <Link to="/sitter/history" className="flex flex-col items-center justify-center p-4 bg-gray-100 rounded-lg hover:bg-blue-100 transition-colors">
                <History className="text-blue-600 mb-2" size={28} /><span className="font-semibold text-gray-700">Histórico</span>
              </Link>
            </div>
          </section>
          ...
          <section className="bg-white p-6 rounded-xl shadow-md">
            ...
            <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-bold text-gray-800">
                        {apt.clientName} - <span className="text-gray-600 font-medium">{apt.petName}</span>
                      </p>
              ...
              {appointments.length === 0 && <div className="text-gray-500">Sem agendamentos futuros.</div>}
            </div>
          </section>
        </main>
      </div>
