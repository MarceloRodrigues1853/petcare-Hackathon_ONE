...
export default function OwnerProfileEdit() {
  ...
  useEffect(() => {
    (async () => {
      try {
        setLoading(true);
        const data = await getOwnerProfile(); // GET /owners/me/profile
        // backend retorna { name, email, phone, bio }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFeedback({
        message: error?.message || "Falha ao atualizar. Tente novamente.",
        type: "error",
      });
    } finally {
      setSaving(false);
  ...
  if (loading) return <div className="p-8 text-center">A carregar o seu perfil...</div>;
    ...
    <div className="bg-slate-50 min-h-screen p-4 sm:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <img
                    src={
                      profile.imageUrl ||
                      `https://placehold.co/100x100/E2E8F0/475569?text=Perfil`
                    }
                    alt="Foto do Perfil"
                  ...
                  <label
                    ...
                    className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2 px-4 rounded-lg flex items-center gap-2"
                  >
          ...
          {/* Seções de endereço/redes sociais continuam só na UI */}
          <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleNestedChange("socials")}
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              disabled={saving}
              className="bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors disabled:bg-blue-300"
            >
